...
//     //elevator shaft (1 shape)
    ...
    //1
    s[7] = new rectPrism(vec3(-0.12,0.019,0.23), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));
    s[8] = new rectPrism(vec3(-0.104,0.019,0.202), 0.068, 0.0068, 0.17, vec3(0.5,0.5,0.5));
    s[9] = new rectPrism(vec3(-0.12,0.019,0.174), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));

    s[10] = new rectPrism(vec3(-0.12,0.019,0.146), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));
    s[11] = new rectPrism(vec3(-0.104,0.019,0.118), 0.068, 0.0068, 0.17, vec3(0.5,0.5,0.5));
    s[12] = new rectPrism(vec3(-0.12,0.019,0.09), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));

    s[13] = new rectPrism(vec3(-0.12,0.019,0.062), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));
    s[14] = new rectPrism(vec3(-0.104,0.019,0.034), 0.068, 0.0068, 0.17, vec3(0.5,0.5,0.5));
    s[15] = new rectPrism(vec3(-0.12,0.019,0.006), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));

    s[16] = new rectPrism(vec3(-0.12,0.019,-0.022), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));
    s[17] = new rectPrism(vec3(-0.104,0.019,-0.05), 0.068, 0.0068, 0.17, vec3(0.5,0.5,0.5));
    s[18] = new rectPrism(vec3(-0.12,0.019,-0.078), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));

    s[19] = new rectPrism(vec3(-0.12,0.019,-0.106), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));
    s[20] = new rectPrism(vec3(-0.104,0.019,-0.134), 0.068, 0.0068, 0.17, vec3(0.5,0.5,0.5));
    s[21] = new rectPrism(vec3(-0.12,0.019,-0.162), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));

    s[22] = new rectPrism(vec3(-0.12,0.019,-0.19), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));
    s[23] = new rectPrism(vec3(-0.104,0.019,-0.218), 0.068, 0.0068, 0.17, vec3(0.5,0.5,0.5));
    s[24] = new rectPrism(vec3(-0.12,0.019,-0.246), 0.068, 0.1, 0.0068, vec3(0.5,0.5,0.5));
