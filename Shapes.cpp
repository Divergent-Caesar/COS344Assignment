...
floorPlan::floorPlan() {
    ...
    // s[1] = new rectPrism(vec3(0,0.138,0.331), 0.822, 0.822, 0.034, vec3(0.5,0.5,0.5)); //east wall with elevator shaft
    // s[2] = new rectPrism(vec3(0,0.138,-0.331), 0.822, 0.822, 0.034, vec3(0.5,0.5,0.5)); //west wall

    // s[3] = new rectPrism(vec3(0.141,0.136,0), 0.822, 0.034, 1.96, vec3(0.5,0.5,0.5)); //north wall 
    ...
    // s[4] =  new rectPrism(vec3(-0.141,0.136,0), 0.822, 0.034, 1.96, vec3(0.5,0.5,0.5)); //south wall with cutouts
...
//     s[8] = new triPrism(vec3(0,0,0), vec3(0,0,0), vec3(0,0,0), vec3(0,0,0), 0.0);
    ...
    s[1] = new rectPrism(vec3(0.06,0.03,0.1), 0.1156, 0.137, 0.0068, vec3(1,1,1));
    s[2] = new rectPrism(vec3(0.0,0.03,0.15), 0.1156, 0.0068, 0.137, vec3(1,1,1));
    s[3] = new rectPrism(vec3(0.0,0.03,0.225), 0.1156, 0.0068, 0.137, vec3(1,1,1));
    s[4] = new rectPrism(vec3(0.0,0.03,-0.01), 0.1156, 0.137, 0.0068, vec3(1,1,1));
    s[5] = new rectPrism(vec3(0.0,0.03,-0.1), 0.1156, 0.137, 0.0068, vec3(1,1,1));
    s[6] = new rectPrism(vec3(0.06,0.03,-0.18), 0.1156, 0.0068, 0.137, vec3(1,1,1));
//     s[287] = new rectPrism(vec3(0,0,0), vec3(0,0,0), vec3(0,0,0), vec3(0,0,0), vec3(0,0,0), 0.0);


    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//     //elevator shaft (1 shape)
//     s[5] = new rectPrism(vec3(0,0,0), vec3(0,0,0), vec3(0,0,0), vec3(0,0,0), vec3(0,0,0), 0.0);
